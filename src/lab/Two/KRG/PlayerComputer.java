 ...
 * *Advanced Java
 *
 * @author Kyle Guzikowski Advanced Java
 *
 *
 * The "PlayerComputer" is designed to let a users play the game alone
 *
 * given that they provide Name, to identify their Character Color, for their
 * Character a character using their name, favorite color E-mail, just to know
 * how many people have played the game -future use could be send results,
 * upload results for the database finals Declared default computer name, and
 * color
 *
 * @version 1.0 9-12-12
 */
